...
R&D collaboration is always welcome, but so is educational and commercial work. Here are some links to start with:
  ...
  - **[Andrew Milne on LinkedIn](https://www.linkedin.com/in/yubik/)** (practical accomplishments at 1QBit, CME Group, Sony, CBC and other great places).  **Take advantage of my experience.**  Remember that for every success there are hundreds of failures and wrong turnings, which no one puts on their resume or brags about online. **Avoid failure** by reviewing your plans with someone who has known both.    
  - **[Andrew Milne on Substack](https://milnea.substack.com).**  **Let's compare our thoughts on larger issues:** Original essays, commentary, pictures, poetry and excerpts from larger works in progress.  I only publish every few weeks or so, and you don't have to subscribe to read the latest articles.  
